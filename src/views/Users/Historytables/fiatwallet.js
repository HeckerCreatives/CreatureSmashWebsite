...
function FiatWalletHistory() {
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/wallethistory/playerwallethistory?type=fiatbalance&page=${page - 1}&limit=10`,{
          method: 'GET',
          credentials: 'include',
          headers: {
...
export default FiatWalletHistory;